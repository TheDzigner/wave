...
let i = 0
  ...
  function playAll()
  {
    playAll_btn.innerHTML = 'restart_alt'
     playState.innerHTML = 'pause_circle'
    showPlayingTitle.innerHTML = audio[0].audio_title  
  showPlayingAuthor.innerHTML = audio[0].audio_author
  showPlayingImg.src = audio[0].audio_cover
  mixe_wrapper_img.src = audio[0].audio_cover
  audioPlay.src = audio[0].audio_src 
  document.querySelector('.showPlayingWrapper').classList.add('active')
